...
export class DashboardTwoNavbar extends Component {
    constructor(props) {
        super(props);
        this.array = [];
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextState.lock !== this.state.lock ||
            nextState.saveSettings !== this.state.saveSettings ||
    ...
    hideBullishStocksConfig() {
        ...
        this.bullishInterval = setInterval(() => {
            ...
            if (!PriceSettings.getHideBullishStocks()) {
                ...
                DashboardTwoCache.setDisableScroll(false);
                DashboardTwoCache.setPriceDetection(false);
                DashboardTwoCache.setUpdateHideStocks(true);
                clearInterval(this.bullishInterval);
            }
            DashboardTwoCache.setDisableScroll(true);
            DashboardTwoCache.hideBullishStocks();
    ...
    hideBearishStocksConfig() {
        ...
        this.bearishInterval = setInterval(() => {
            ...
            DashboardTwoCache.setDisableScroll(true);
            DashboardTwoCache.hideBearishStocks();
    ...
    async addToHistoricalTable() {
        ...
        const json = DashboardTwoCache.get(target);
